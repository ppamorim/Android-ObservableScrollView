 ...
 */
public interface ObservableRecyclerViewCallbacks {
  /**
   ...
   *
   * @param scrollValue     scroll position in X or Y axis
   ...
   */
  void onScrollChanged(int scrollValue, boolean firstScroll, boolean dragging);
