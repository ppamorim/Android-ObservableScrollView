...
public abstract class SlidingUpBaseRecyclerActivity<S extends RecyclerViewScrollable> extends BaseActivity implements
  ...
  private View.OnClickListener fabClickListener = new View.OnClickListener() {
    ...
    public void onClick(View v) {
      Toast.makeText(SlidingUpBaseRecyclerActivity.this, "floating action button clicked",
